...
lbClear 1850;
 if (ACE3_Enabled == 1) then {
   ...
   _index744=lbAdd[1850,"EMPTY         Price:   $45.00"];_Pic10=getText(configFile >>"CfgWeapons">>"EMPTY">>"picture");lbSetPicture[1850,9,_Pic10];lbSetPictureColor[1850,9,[0.9,0.9,0.9,0.8]];
