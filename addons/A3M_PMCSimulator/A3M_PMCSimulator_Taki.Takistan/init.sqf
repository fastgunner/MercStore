...
if (isDedicated) then {
	...
	if ((isServer) and (!IsDedicated))then {		
		...
		titleText ["A3M | PMC SIMULATOR TAKISTAN EDITION *  LOADING, PLEASE WAIT..... ", "BLACK FADED",10];
		...
		hint "WARNING: This mission is best played on a dedicated server. This is a performance demanding mode, and will degrade performance on most client-hosted machines.";
	...
	titleText ["A3M | PMC SIMULATOR TAKISTAN EDITION *  LOADING, PLEASE WAIT..... ", "BLACK FADED",1];
	...
	systemChat "Loading Phase * A3M PMC Simulator | Takistan Edition * 100% Complete...";
