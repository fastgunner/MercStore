...
// APFC FACTION
	if (_faction==5) then {
	_InfPool=	["A3M_APFC_ME_Rifleman_1","A3M_APFC_ME_Rifleman_2","A3M_APFC_ME_Rifleman_AT","A3M_APFC_ME_AutoRifleman","A3M_APFC_ME_Rifleman_Elite","A3M_APFC_ME_Criminal","A3M_APFC_ME_Medic","A3M_APFC_ME_Engineer" ];	
	_ArmPool=	["C_Hatchback_01_F","C_Hatchback_01_sport_F","C_Quadbike_01_F","C_SUV_01_F","C_Van_01_transport_F","C_Van_01_box_F"];
	_MotPool=	["C_Hatchback_01_F","C_Hatchback_01_sport_F","C_Quadbike_01_F","C_SUV_01_F","C_Van_01_transport_F","C_Van_01_box_F"];
	_ACHPool=	[];
	_CHPool=	[];
	...
	_shipPool=	["C_Boat_Civil_01_F","C_Boat_Civil_01_rescue_F","C_Boat_Civil_04_F","C_Rubberboat"];
	_diverPool=	[];
	_crewPool=	["A3M_APFC_ME_Rifleman_1"];
	_heliCrew=	["A3M_APFC_ME_Rifleman_1"];
	};
