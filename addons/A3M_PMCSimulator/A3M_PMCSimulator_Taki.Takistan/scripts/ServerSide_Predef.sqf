...
if (EnPres == 1) then {
_HVTen= [getMarkerPos "PublicDestination", EAST, ["A3M_APFC_ME_Rifleman_2", "A3M_APFC_ME_AutoRifleman", "A3M_APFC_ME_Rifleman_1", "A3M_APFC_ME_Rifleman_Elite"]] call BIS_fnc_spawnGroup;
...
if (EnPres == 1) then {
_HVTen= [getMarkerPos "PubDelDestination", EAST, ["A3M_APFC_ME_Rifleman_2", "A3M_APFC_ME_AutoRifleman", "A3M_APFC_ME_Rifleman_1", "A3M_APFC_ME_Rifleman_Elite"]] call BIS_fnc_spawnGroup;
...
waitUntil {behaviour SAR1 == "CARELESS"};
...
_HSTF= [getPos SAR1, EAST, ["A3M_APFC_ME_Rifleman_1", "A3M_APFC_ME_Rifleman_AT", "A3M_APFC_ME_Rifleman_2", "A3M_APFC_ME_AutoRifleman", "A3M_APFC_ME_Rifleman_Elite", "A3M_APFC_ME_Rifleman_1"]] call BIS_fnc_spawnGroup;
[_HSTF, getPos SAR1] call BIS_fnc_taskDefend; 

_bluNums = west countSide allPlayers;

if (_bluNums > 10) then {
_HSTF2= [getPos SAR1, EAST, ["A3M_APFC_ME_Rifleman_1", "A3M_APFC_ME_Rifleman_AT", "A3M_APFC_ME_Rifleman_2", "A3M_APFC_ME_AutoRifleman", "A3M_APFC_ME_Rifleman_Elite", "A3M_APFC_ME_Rifleman_1"]] call BIS_fnc_spawnGroup;
[_HSTF2, getPos SAR1, 200] call BIS_fnc_taskPatrol; 

_HSTF3= [getPos SAR1, EAST, ["A3M_APFC_ME_Rifleman_1", "A3M_APFC_ME_Rifleman_AT", "A3M_APFC_ME_Rifleman_2", "A3M_APFC_ME_AutoRifleman", "A3M_APFC_ME_Rifleman_Elite", "A3M_APFC_ME_Rifleman_1"]] call BIS_fnc_spawnGroup;
[_HSTF3, getPos SAR1, 200] call BIS_fnc_taskPatrol; 
};
if (_bluNums > 20) then {
_HSTF4= [getPos SAR1, EAST, ["A3M_APFC_ME_Rifleman_1", "A3M_APFC_ME_Rifleman_AT", "A3M_APFC_ME_Rifleman_2", "A3M_APFC_ME_AutoRifleman", "A3M_APFC_ME_Rifleman_Elite", "A3M_APFC_ME_Rifleman_1"]] call BIS_fnc_spawnGroup;
...
_GH1tm= [getMarkerPos "GH1", EAST, ["A3M_APFC_ME_Rifleman_1", "A3M_APFC_ME_Rifleman_AT", "A3M_APFC_ME_Rifleman_2", "A3M_APFC_ME_AutoRifleman", "A3M_APFC_ME_Rifleman_Elite", "A3M_APFC_ME_Rifleman_1"]] call BIS_fnc_spawnGroup;
[_GH1tm, getMarkerPos "GH1"] call BIS_fnc_taskDefend; 

_GH2tm= [getMarkerPos "GH2", EAST, ["A3M_APFC_ME_Rifleman_1", "A3M_APFC_ME_Rifleman_AT", "A3M_APFC_ME_Rifleman_2", "A3M_APFC_ME_AutoRifleman", "A3M_APFC_ME_Rifleman_Elite", "A3M_APFC_ME_Rifleman_1"]] call BIS_fnc_spawnGroup;
[_GH2tm, getMarkerPos "GH2"] call BIS_fnc_taskDefend; 

if (_bluNums > 10) then {
_GH3tm= [getMarkerPos "GH3", EAST, ["A3M_APFC_ME_Rifleman_1", "A3M_APFC_ME_Rifleman_AT", "A3M_APFC_ME_Rifleman_2", "A3M_APFC_ME_AutoRifleman", "A3M_APFC_ME_Rifleman_Elite", "A3M_APFC_ME_Rifleman_1"]] call BIS_fnc_spawnGroup;
[_GH3tm, getMarkerPos "GH3"] call BIS_fnc_taskDefend; 

_GH4tm= [getMarkerPos "GH4", EAST, ["A3M_APFC_ME_Rifleman_1", "A3M_APFC_ME_Rifleman_AT", "A3M_APFC_ME_Rifleman_2", "A3M_APFC_ME_AutoRifleman", "A3M_APFC_ME_Rifleman_Elite", "A3M_APFC_ME_Rifleman_1"]] call BIS_fnc_spawnGroup;
[_GH4tm, getMarkerPos "sg1"] call BIS_fnc_taskDefend; 
};

if (_bluNums > 20) then {
_GH5tm= [getMarkerPos "GH5", EAST, ["A3M_APFC_ME_Rifleman_1", "A3M_APFC_ME_Rifleman_AT", "A3M_APFC_ME_Rifleman_2", "A3M_APFC_ME_AutoRifleman", "A3M_APFC_ME_Rifleman_Elite", "A3M_APFC_ME_Rifleman_1"]] call BIS_fnc_spawnGroup;
[_GH5tm, getMarkerPos "GH5", 200] call BIS_fnc_taskPatrol; 

_GH6tm= [getMarkerPos "GH6", EAST, ["A3M_APFC_ME_Rifleman_1", "A3M_APFC_ME_Rifleman_AT", "A3M_APFC_ME_Rifleman_2", "A3M_APFC_ME_AutoRifleman", "A3M_APFC_ME_Rifleman_Elite", "A3M_APFC_ME_Rifleman_1"]] call BIS_fnc_spawnGroup;
...
Raid1Win setTriggerArea [550, 550, 0, false]; 
Raid1Win setTriggerActivation ["EAST", "NOT PRESENT", false]; 
Raid1Win setTriggerType "NONE";
Raid1Win setTriggerStatements ["this", "[[], 'A3M_svr_RaidClear', false, false, false] call bis_fnc_MP",""]; 

R1marker = createMarker ["Raid1Marker", getMarkerPos "sg1"];
R1marker setMarkerShape "ELLIPSE";
R1marker setMarkerSize [550,550];
R1marker setMarkerColor "ColorRed";
};
A3M_svr_Raid2= {
...
// Create Enemy Presence (Contains Leights Opfor)
_GH1tm= [getMarkerPos "RO1", EAST, ["A3M_APFC_ME_Rifleman_1", "A3M_APFC_ME_Rifleman_AT", "A3M_APFC_ME_Rifleman_2", "A3M_APFC_ME_AutoRifleman", "A3M_APFC_ME_Rifleman_Elite", "A3M_APFC_ME_Rifleman_1"]] call BIS_fnc_spawnGroup;
[_GH1tm, getMarkerPos "RO1"] call BIS_fnc_taskDefend; 

_GH2tm= [getMarkerPos "RO2", EAST, ["A3M_APFC_ME_Rifleman_1", "A3M_APFC_ME_Rifleman_AT", "A3M_APFC_ME_Rifleman_2", "A3M_APFC_ME_AutoRifleman", "A3M_APFC_ME_Rifleman_Elite", "A3M_APFC_ME_Rifleman_1"]] call BIS_fnc_spawnGroup;
[_GH2tm, getMarkerPos "RO2"] call BIS_fnc_taskDefend; 

if (_bluNums > 10) then {
_GH3tm= [getMarkerPos "RO3", EAST, ["A3M_APFC_ME_Rifleman_1", "A3M_APFC_ME_Rifleman_AT", "A3M_APFC_ME_Rifleman_2", "A3M_APFC_ME_AutoRifleman", "A3M_APFC_ME_Rifleman_Elite", "A3M_APFC_ME_Rifleman_1"]] call BIS_fnc_spawnGroup;
[_GH3tm, getMarkerPos "RO3"] call BIS_fnc_taskDefend; 

_GH4tm= [getMarkerPos "RO4", EAST, ["A3M_APFC_ME_Rifleman_1", "A3M_APFC_ME_Rifleman_AT", "A3M_APFC_ME_Rifleman_2", "A3M_APFC_ME_AutoRifleman", "A3M_APFC_ME_Rifleman_Elite", "A3M_APFC_ME_Rifleman_1"]] call BIS_fnc_spawnGroup;
[_GH4tm, getMarkerPos "sg2"] call BIS_fnc_taskDefend; 
};

if (_bluNums > 20) then {
_GH5tm= [getMarkerPos "RO5", EAST, ["A3M_APFC_ME_Rifleman_1", "A3M_APFC_ME_Rifleman_AT", "A3M_APFC_ME_Rifleman_2", "A3M_APFC_ME_AutoRifleman", "A3M_APFC_ME_Rifleman_Elite", "A3M_APFC_ME_Rifleman_1"]] call BIS_fnc_spawnGroup;
[_GH5tm, getMarkerPos "RO5"] call BIS_fnc_taskDefend; 

_GH6tm= [getMarkerPos "RO6", EAST, ["A3M_APFC_ME_Rifleman_1", "A3M_APFC_ME_Rifleman_AT", "A3M_APFC_ME_Rifleman_2", "A3M_APFC_ME_AutoRifleman", "A3M_APFC_ME_Rifleman_Elite", "A3M_APFC_ME_Rifleman_1"]] call BIS_fnc_spawnGroup;
...
Raid2Win setTriggerArea [550, 550, 0, false]; 
Raid2Win setTriggerActivation ["EAST", "NOT PRESENT", false]; 
Raid2Win setTriggerType "NONE";
Raid2Win setTriggerStatements ["this", "[[], 'A3M_svr_RaidClear', false, false, false] call bis_fnc_MP",""]; 

R2marker = createMarker ["Raid2Marker", getMarkerPos "sg2"];
R2marker setMarkerShape "ELLIPSE";
R2marker setMarkerSize [550,550];
R2marker setMarkerColor "ColorRed";
};
A3M_svr_RaidClear= {
...
if (!isNull Raid1Win) then {deleteVehicle Raid1Win; DeleteMarker "Raid1Marker"};
if (!IsNull Raid2Win) then {deleteVehicle Raid2Win; DeleteMarker "Raid2Marker"};  
...
T9EF= [getMarkerPos T9EnSource, EAST, ["A3M_APFC_ME_Rifleman_1", "A3M_APFC_ME_Rifleman_AT", "A3M_APFC_ME_Rifleman_2", "A3M_APFC_ME_AutoRifleman", "A3M_APFC_ME_Rifleman_Elite"]] call BIS_fnc_spawnGroup;
...
T9EF2= [getMarkerPos T9EnSource, EAST, ["A3M_APFC_ME_Rifleman_1", "A3M_APFC_ME_Rifleman_AT", "A3M_APFC_ME_Rifleman_2", "A3M_APFC_ME_AutoRifleman", "A3M_APFC_ME_Rifleman_Elite"]] call BIS_fnc_spawnGroup;
...
T9EF3= [getMarkerPos T9EnSource, EAST, ["A3M_APFC_ME_Rifleman_1", "A3M_APFC_ME_Rifleman_AT", "A3M_APFC_ME_Rifleman_2", "A3M_APFC_ME_AutoRifleman", "A3M_APFC_ME_Rifleman_Elite"]] call BIS_fnc_spawnGroup;
...
RBduty SetSimpleTaskDescription ["Stand at the checkpoint and perform stop and search checkpoint duties with the authority of the Takistan Armed Forces.", "Move To Checkpoint Duty", " Checkpoint C-12N"];
...
RBduty2 SetSimpleTaskDescription ["Wait for cars to stop at the checkpoint and perform stop and search checkpoint duties with the authority of the Takistani Government.", "Perform Checkpoint Duty", " Checkpoint C-12N"];
RBduty2 SetSimpleTaskDestination (getMarkerPos "RBC");
RBduty2 setTaskState "Assigned"; 

titleText ["Welcome to the C-12 South Checkpoint. Perform stop and search duties on Takistani Nationals. Be suspicious of terroristic threats.", "PLAIN DOWN"];
...
greet= RBVeh addAction ["Greeting", {Hint "Hello. How are you today sir? Im a Takistani Citizen." }];
...
RBveh addAction ["Search", {RBVehD LeaveVehicle RBVeh; hint "I did nothing to you! Why are you judging me like this? Don't judge me! "; sleep 2; hint "Searching Car....."; sleep 5; hint "Found open bottle of Russian vodka"; RBVehD addAction ["Return to Vehicle", {RBVehD moveInDriver RBVeh} ]; RBVehD addAction ["Arrest for DWI", { mantype= 4; publicVariable "mantype"; Hint "Abreast? Arrest meee? Fuck YOU! You aren't GAWD!"; sleep 2; hint "Escort the Suspect to Takistani jail. Alternately, use the Fast Transport option in the action menu to fast travel the suspect to Takistani Jail."; sleep 2; [] call A3M_fnc_jailtrigger;}];}];
...
mantype= "M1";
removeAllActions RBVeh; 
RBveh addAction ["Greeting", {Hint "Hello sir. All is okay here, yes? I am Takistani Citizen." }];
...
RBveh addAction ["Search", {RBVehD LeaveVehicle RBVeh; hint "I better call my lawyer. I'm not saying anything until my attorney arrives. Oh my God."; sleep 2.0; hint "Searching Car....."; sleep 6; hint "You found a load of cocaine"; sleep 2; hint "Driver: Step out of the vehicle! \n \n If the driver refuses to exit, shoot the vehicle's tires and disable it!";
		...
		RBVehD addAction ["Sir, You are under arrest...", { mantype= "M4"; publicVariable "mantype"; Hint "Oh God...Oh My God....Ohhhh Shit. Fuck...FUCK ME! "; sleep 3.0; hint "Transport the Criminal to Takistani Jail. Alternately, use the Fast Transport option in the action menu to fast travel the suspect to Takistani Jail."; [] call A3M_fnc_jailtrigger; }];}];	
...
RBveh addAction ["Search", { RBVehD LeaveVehicle RBVeh; hint "Dis No Gut."; sleep 2.0; hint "Searching Car....."; sleep 5; hint "Found Multiple Identifications. Upon further review, the Takistani Citizen Number on the Takistani ID doesn't check out..."; RBVehD addAction ["Return to Vehicle", {RBVehD moveInDriver RBVeh}]; RBVehD addAction ["Arrest for Illegal Immigration", { mantype= "M4"; publicVariable "mantype"; Hint "Fock you mane. You cops are always trying to keepa de mano down!  "; sleep 3.0; hint "Escort the Illegal Alien to Takistani Jail. Alternately, use the Fast Transport option in the action menu to fast travel the suspect to Takistani Jail."; [] call A3M_fnc_jailtrigger; } ]; } ];
...
removeAllActions RBVeh; 
RBVeh setDamage 0.3; 
RBveh addAction ["Greeting", {Hint "Im an Takistani Citizen. What the fuck do you want? Fuck outta my way, bitch!" }];
backscatter= RBVeh addAction ["Backscatter Scanner", {Hint "Anomaly Detected"} ]; 
...
mantype= "M2"; 
removeAllActions RBVeh; 
RBveh addAction ["Greeting", {Hint "I'm an Takistani Citizen. Let me pass." }];
backscatter= RBVeh addAction ["Backscatter Scanner", {Hint "Anomaly Detected"}]; 
...
RBveh addAction ["Greeting", {Hint "I'm an Takistani Citizen. Let me pass. Immediately" }];
...
RBveh addAction ["Greeting", {Hint "Hello! I'm an Takistani Citizen." }];
...
mantype= "M1"; 
removeAllActions RBVeh; 
greet= RBVeh addAction ["Greeting", {Hint "How are you today sir. Im an Takistani Citizen." }];
backscatter= RBVeh addAction ["Backscatter Scanner", {Hint "Anomaly Detected"} ]; 
inspect= RBVeh addAction ["Inspect Vehicle", {Hint "Visual Inspection: \n The vehicle appears clean and in good repair. \n Smells:\n The vehicle doesn't smell of anything at all.  \n Driver Attitude: \n Driver appears calm and cooperative"} ];
search= RBVeh addAction ["Search", {RBVehD LeaveVehicle RBVeh; hint "Officer, is this really needed? This is just stupid. I know my rights! Call my lawyer! "; hint "Searching Car....."; sleep 6; hint "You found a load of heroin."; sleep 2; hint "Driver: Step out of the vehicle! \n \n If the driver refuses to exit, shoot the vehicle's tires and disable it!"; RBVehD addAction ["Return to Vehicle", {RBVehD moveInDriver RBVeh} ]; RBVehD addAction ["Sir, You are under arrest...", { mantype= "M4"; publicVariable "mantype"; Hint "Oh Mother of God. I've really done it now."; sleep 3.0; hint "Transport the Criminal to Takistani Jail.  Alternately, use the Fast Transport option in the action menu to fast travel the suspect to Takistani Jail.";[] call A3M_fnc_jailtrigger;}];}]; 
goSouth= RBVeh addAction ["Allow to Proceed", {hint "Thank you sir, I'll be moving on now"; [] Call DoExitStopSouth; }];  
...
[ '','RemAllAct',True,False] call BIS_fnc_MP;
deleteVehicle RBVeh; 
MJMP= createTrigger ["EmptyDetector", getMarkerPos "TAF_Jail"]; 
...
A3M_Booked_MP = {
hint "Prisoner has been booked into Takistani Police Custody. Thank you!";
ALTEscort setTaskState "Succeeded";  
playMusic "Success";
mantype = "M0";
}; 
A3M_fnc_booked= {
RBVehD setPos (GetMarkerPos "TAF_Jail"); 
...
ALTEscort=player createSimpleTask ["Escort Prisoner to Takistani Jail"]; 
ALTEscort SetSimpleTaskDescription ["Escort the Takistani Law Breaker to Takistani Jail.", "Jail Transport", "Takistani Jail"];
ALTEscort SetSimpleTaskDestination (getMarkerPos "TAF_Jail");
