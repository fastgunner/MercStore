...
_index358=lbAdd[1850,"Booniehat [TAF]                   Price:   $75.00"];_Pic21=getText(configFile >>"CfgWeapons">>"H_Booniehat_dgtl">>"picture");lbSetPicture[1850,20,_Pic21];lbSetPictureColor[1850,20,[0.9,0.9,0.9,0.8]];
...
_index382=lbAdd[1850,"Heli Crew Helmet [TAF]            Price:   $250.00"];_Pic45=getText(configFile >>"CfgWeapons">>"H_CrewHelmetHeli_I">>"picture");lbSetPicture[1850,44,_Pic45];lbSetPictureColor[1850,44,[0.9,0.9,0.9,0.8]];
...
_index408=lbAdd[1850,"Crew Helmet [TAF]                 Price:   $250.00"];_Pic71=getText(configFile >>"CfgWeapons">>"H_HelmetCrew_I">>"picture");lbSetPicture[1850,70,_Pic71];lbSetPictureColor[1850,70,[0.9,0.9,0.9,0.8]];
...
_index424=lbAdd[1850,"Military Cap [TAF]                Price:   $5.00"];_Pic87=getText(configFile >>"CfgWeapons">>"H_MilCap_dgtl">>"picture");lbSetPicture[1850,86,_Pic87];lbSetPictureColor[1850,86,[0.9,0.9,0.9,0.8]];
...
_index431=lbAdd[1850,"Pilot Helmet [TAF]                Price:   $12,150.00"];_Pic94=getText(configFile >>"CfgWeapons">>"H_PilotHelmetFighter_I">>"picture");lbSetPicture[1850,93,_Pic94];lbSetPictureColor[1850,93,[0.9,0.9,0.9,0.8]];
...
_index434=lbAdd[1850,"Heli Pilot Helmet [TAF]           Price:   $4,525.00"];_Pic97=getText(configFile >>"CfgWeapons">>"H_PilotHelmetHeli_I">>"picture");lbSetPicture[1850,96,_Pic97];lbSetPictureColor[1850,96,[0.9,0.9,0.9,0.8]];
...
lbClear 1850;
 if (ACE3_Enabled == 1) then {
   ...
   _index744=lbAdd[1850,"Nothing         Price:   $0.00"];_Pic10=getText(configFile >>"CfgWeapons">>"Empty">>"picture");lbSetPicture[1850,9,_Pic10];lbSetPictureColor[1850,9,[0.9,0.9,0.9,0.8]];
...
Case 0: { if (Wallet<rhs_weap_igla ) then {
  Hint Format ["Attention: Your Card Was Declined in the amount of:\n $%1.00 \n Please contact your financial institution.", rhs_weap_igla ]; } else {
   PlaySound "A3M_buy";
   Hint format ["You have ordered 9K38 Igla TAFor $%1.00. Your order will be delivered soon! Check the deliveries box often!", rhs_weap_igla ];
...
Case 20: { if (Wallet< H_Booniehat_dgtl) then {
  Hint Format ["Attention: Your Card Was Declined in the amount of:\n $%1.00 \n Please contact your financial institution.", H_Booniehat_dgtl]; }else { 
   PlaySound "A3M_buy";   
   Hint format ["You have ordered  Booniehat [TAF] for $%1.00. Your order will be delivered soon! Check the deliveries box often!",H_Booniehat_dgtl]; 
   Wallet= (wallet -   H_Booniehat_dgtl);
   profileNamespace setVariable ["SavedMoney", Wallet];
   SaveProfileNamespace; 
   Sleep DeliveryTime;  
   Deliveries  AddItemCargoGlobal  ["H_Booniehat_dgtl", 1]; 
   hint "Mail Call: Your   Booniehat [TAF]  has arrived in the deliveries box";}; 
  };
...
Case 44: { if (Wallet< H_CrewHelmetHeli_I  ) then {
  Hint Format ["Attention: Your Card Was Declined in the amount of:\n $%1.00 \n Please contact your financial institution.", H_CrewHelmetHeli_I  ]; }else {  
   PlaySound "A3M_buy";  
   Hint format ["You have ordered  Heli Crew Helmet [TAF]  for $%1.00. Your order will be delivered soon! Check the deliveries box often!",H_CrewHelmetHeli_I  ];  
   Wallet= (wallet -   H_CrewHelmetHeli_I  );  
   profileNamespace setVariable ["SavedMoney", Wallet];
   SaveProfileNamespace;   
   Sleep DeliveryTime;  
   Deliveries  AddItemCargoGlobal  ["H_CrewHelmetHeli_I", 1]; 
   hint "Mail Call: Your   Heli Crew Helmet [TAF]   has arrived in the deliveries box";};
  };
...
Case 70: { if (Wallet< H_HelmetCrew_I  ) then {
  Hint Format ["Attention: Your Card Was Declined in the amount of:\n $%1.00 \n Please contact your financial institution.", H_HelmetCrew_I  ]; }else { 
   PlaySound "A3M_buy";   
   Hint format ["You have ordered  Crew Helmet [TAF]   for $%1.00. Your order will be delivered soon! Check the deliveries box often!",H_HelmetCrew_I  ]; 
   Wallet= (wallet -   H_HelmetCrew_I  ); 
   profileNamespace setVariable ["SavedMoney", Wallet];
   SaveProfileNamespace;   
   Sleep DeliveryTime;   
   Deliveries  AddItemCargoGlobal  ["H_HelmetCrew_I", 1]; 
   hint "Mail Call: Your   Crew Helmet [TAF]has arrived in the deliveries box";}; 
  };
...
Case 86: { if (Wallet< H_MilCap_dgtl   ) then {
  Hint Format ["Attention: Your Card Was Declined in the amount of:\n $%1.00 \n Please contact your financial institution.", H_MilCap_dgtl   ]; }else {   
   PlaySound "A3M_buy";  
   Hint format ["You have ordered  Military Cap [TAF]  for $%1.00. Your order will be delivered soon! Check the deliveries box often!",H_MilCap_dgtl   ];  
   Wallet= (wallet -   H_MilCap_dgtl   );
   profileNamespace setVariable ["SavedMoney", Wallet];
   SaveProfileNamespace;  
   Sleep DeliveryTime;  
   Deliveries  AddItemCargoGlobal  ["H_MilCap_dgtl", 1]; 
   hint "Mail Call: Your   Military Cap [TAF]   has arrived in the deliveries box";};  
  };
...
Case 93: { if (Wallet< H_PilotHelmetFighter_I  ) then {
  Hint Format ["Attention: Your Card Was Declined in the amount of:\n $%1.00 \n Please contact your financial institution.", H_PilotHelmetFighter_I  ]; }else { 
   PlaySound "A3M_buy";   
   Hint format ["You have ordered  Pilot Helmet [TAF]  for $%1.00. Your order will be delivered soon! Check the deliveries box often!",H_PilotHelmetFighter_I  ]; 
   Wallet= (wallet -   H_PilotHelmetFighter_I  ); 
   profileNamespace setVariable ["SavedMoney", Wallet];
   SaveProfileNamespace;   
   Sleep DeliveryTime;  
   Deliveries  AddItemCargoGlobal  ["H_PilotHelmetFighter_I", 1];
   hint "Mail Call: Your   Pilot Helmet [TAF]   has arrived in the deliveries box";};  
  };
...
Case 96: { if (Wallet< H_PilotHelmetHeli_I ) then {
  Hint Format ["Attention: Your Card Was Declined in the amount of:\n $%1.00 \n Please contact your financial institution.", H_PilotHelmetHeli_I ]; }else {   
   PlaySound "A3M_buy";  
   Hint format ["You have ordered  Heli Pilot Helmet [TAF] for $%1.00. Your order will be delivered soon! Check the deliveries box often!",H_PilotHelmetHeli_I ]; 
   Wallet= (wallet -   H_PilotHelmetHeli_I ); 
   profileNamespace setVariable ["SavedMoney", Wallet];
   SaveProfileNamespace;   
   Sleep DeliveryTime;  
   Deliveries  AddItemCargoGlobal  ["H_PilotHelmetHeli_I", 1];
   hint "Mail Call: Your   Heli Pilot Helmet [TAF]  has arrived in the deliveries box";}; 
  };
